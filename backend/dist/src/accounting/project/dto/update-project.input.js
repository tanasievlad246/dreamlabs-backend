...
const project_input_1 = require("./project.input");
let UpdateProjectInput = class UpdateProjectInput extends (0, graphql_1.PartialType)(project_input_1.CreateProjectInput) {
};
