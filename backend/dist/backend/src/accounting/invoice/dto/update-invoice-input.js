...
const invoice_input_1 = require("./invoice.input");
let UpdateInvoiceInput = class UpdateInvoiceInput extends (0, graphql_1.PartialType)(invoice_input_1.CreateInvoiceInput) {
};
